...
function Home(){
    ...
    return(
        ...
        <div id="modelli_auto" className="pt-6 flex" >
        ...
        <div className="flex flex-col items-center justify-center mb-16 flex-grow sm:h-max sm:w-max lg:text-3xl">
            <p className="font-serif">I nostri modelli</p>
